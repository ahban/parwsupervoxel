...
function [result LBP] = lbp(varargin) % image,radius,neighbors,mapping,mode)
% Version 0.3.2
...
LBP(origy:origy+dy,origx:origx+dx)=result;
ofs=1;
LBP = padarray(LBP(1+ofs:end-ofs,1+ofs:end-ofs),[ofs,ofs],'replicate');
